                            ...
                            <a class="pos-relative h-100 dplay-block" href="/posts/{{ $posts->slug }}">
                                ...
                                <div class="abs-blr color-white p-20 bg-sm-color-7">
                                    ...
                                    <ul class="list-li-mr-20">
                                        <li>{!!  $posts->published_at->format('d/m/Y') !!}</li>
                                        <li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>{{ $posts->views }}
                                        </li>
                                ...
                                <a class="pos-relative h-100 dplay-block" href="/posts/{{ $posts->slug }}">
                                    ...
                                    <div class="abs-blr color-white p-20 bg-sm-color-7">
                                        ...
                                        <ul class="list-li-mr-20">
                                            <li>{!!  $posts->published_at->format('d/m/Y') !!}</li>
                                            <li>
                                                <i class="color-primary mr-5 font-12 ion-ios-bolt"></i>{{ $posts->views }}
                                            </li>
                                            @foreach($posts->tags as $tag)
                                                <li>
                    ...
                    @foreach($post as $index => $posts)
                        @if($index > 8 && $index <= 9 )
                            <div class="col-6">
                                ...
                                <ul class="list-li-mr-20">
                                    <li>{!!  $posts->published_at->format('d/m/Y') !!}</li>
                                    <li><i class="color-primary mr-5 font-12 ion-ios-bolt"></i>{{ $posts->views }}</li>
                                    @foreach($posts->tags as $tag)
                                        <li>
                                            <i class="color-primary mr-5 font-12 ion-ios-pricetag"></i>{{ $tag->tag }}</span>
                                        </li>
                ...
                @foreach($post as $index => $posts)
                    @if($index > 21 && $index < 27 )
                        <a class="oflow-hidden pos-relative mb-20 dplay-block" href="/posts/{{ $posts->slug }}">
                            <div class="wh-100x abs-tlr"><img src="{{$posts->post_image}}" alt="{{$posts->title}}">
                            </div>
                            <div class="ml-120 min-h-100x">
                                <h5><b>{{$posts->title}}</b></h5>
                                <h6 class="color-lite-black pt-10"><i
                                        class="color-primary mr-5 font-12 ion-ios-bolt"></i> {!!  $posts->views !!}</h6>
                                <h6 class="color-lite-black pt-10">
                                    {!!  $posts->published_at->format('d/m/Y') !!}
                                </h6>
                            </div>
                        </a><!-- oflow-hidden -->
                    @endif
