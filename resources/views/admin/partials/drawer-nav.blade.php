<div class="sidebar-wrapper">
    <ul class="nav">
        ...
        @if(Auth::check() && Auth::user()->hasPermission('perms.admin'))
            ...
            <li><a class="categories" href="/admin/settings" aria-expanded="false"><i
                        class="fa fa-dedent"></i><span
                        class="hide-menu">{!! trans('admin.drawer-nav.settings') !!}</span></a>
            </li>
            <li><a class="categories" href="/admin/categories" aria-expanded="false"><i
                        class="fa fa-bars"></i><span
                        class="hide-menu">{!! trans('admin.drawer-nav.category') !!}</span></a>
            </li>
        @endif
