@extends('layouts.app'){{ $category->name }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="/admin/categories/{{ $category->id }}/edit"
                                   class="btn btn-labeled shiny btn-warning edit"><i class="btn-label fa fa-edit"></i>
                                    Edit</a>
                            </div>
                            <div class="col-md-2">
                                ...
                                <button type="submit" class="btn btn-labeled shiny btn-danger"><i
