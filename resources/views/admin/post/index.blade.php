            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('posts.create') }}" class="btn btn-sm pull-right" data-toggle="tooltip"
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="posts-table" class="table table-sm">
                                ...
                                <th>
                                    {{ trans('admin.posts.table.titles.AddGallery') }}
                                </th>
                                <th></th>
                                <th>
                                ...
                                @foreach ($posts as $post)
                                    <tr>
                                        ...
                                        <td data-order="{{ $post->published_at }}" class="data-style">
                                            @php
                                                $status = 'Draft';
                                        ...
                                        <td><a href="/admin/sliders/{{ $post->id }}/post"
                                               class="btn btn-info">{{ trans('admin.posts.table.titles.AddGallery') }}
                                            </a>
                                        </td>
                                        <td><span>{{ trans('admin.posts.table.titles.imagescount') }}
                                ...
                                {!! join('</span> <span class="badge badge-light badge-pill">', $post->tagLinks()) !!}
                                        ...
                                        <td>
                                            <a href="/admin/posts/{{ $post->id }}/edit"
                                               class="btn btn-sm btn-block btn-info" data-toggle="tooltip"
