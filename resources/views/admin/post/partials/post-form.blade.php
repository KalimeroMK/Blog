<div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-md-9 mb-4 mb-md-0">
                        <div class="row">
                            <div class="col-12 mb-1">
                                <a id="post_image_trigger" data-input="post_image" data-preview="post_image_preview"
                                   class="btn btn-primary text-white btn-block">
                                    {!! trans('forms.edit-post.buttons.choose-image') !!}
                                </a>
                            </div>
                            <div class="col-12 mt-2 mb-1">
                                <input type="text" id="post_image" class="form-control" name="post_image"
                                       placeholder="{{ trans('forms.edit-post.labels.post-image-url') }}"
                    ...
                    <div class="col-12 col-md-3 pull-right mb-3 mt-md-2">
                        <img src="{{ post_image($post_image) }}" id="post_image_preview" class="img img_responsive"
                             alt="Post Image Thumbnail" draggable="false">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-md-4">
        ...
        <div class="form-group has-feedback row {{ $errors->has('category') ? ' has-error ' : '' }}">
            {!! Form::label('category', trans('forms.edit-post.labels.post-category'), ['class' => 'col-12 control-label']); !!}
            <div class="col-12">
